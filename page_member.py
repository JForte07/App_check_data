...
def page_membre():
    ...
    st.write("Sur cette page Nous vérifierons seulement les informations relatives aux membre excluant les pass et les souscriptions.")
    ...
    st.write("Si vous choississez par le rapport sur le Backoffice directement , vous aurez besoin des informations suivantes : noms prenoms mails,date d'inscription date de naissance genre adress note et tag. Veuillez importer les information ici : ")
